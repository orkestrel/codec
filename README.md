...
| Name                | Kind     | Signature                                                | Behavior                                                                                                                                                                               |
| ------------------- | -------- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `encodeUTF8`        | function | `(text: string) => Uint8Array<ArrayBuffer> \| undefined` | Spells `text` in the RFC 3629 shortest form; `undefined` for exactly the ill-formed strings.                                                                                           |
...
| `encodeLatin1`      | function | `(text: string) => Uint8Array<ArrayBuffer> \| undefined` | Writes each code unit as the byte of the same value; `undefined` when a code unit exceeds 0xFF.                                                                                        |
| `decodeLatin1`      | function | `(bytes: Uint8Array) => string`                          | Reads each byte as the code point of the same value. Total: this decoder has no failure mode.                                                                                          |
...
| `encodeWindows1252` | function | `(text: string) => Uint8Array<ArrayBuffer> \| undefined` | Inverts the decode mapping; `undefined` for a character outside the code page's image, every C1 control included.                                                                      |
...
| `encodeUTF16LE`     | function | `(text: string) => Uint8Array<ArrayBuffer> \| undefined` | Writes each code unit low byte first; `undefined` for exactly the ill-formed strings.                                                                                                  |
